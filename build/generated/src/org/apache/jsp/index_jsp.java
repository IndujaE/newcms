...
String sql1 = "SELECT * FROM `event_head` WHERE `PAGE`=1 ";
...
//ResultSet rs= null;
 ...
 ps1=con.prepareStatement("select * from event_head");
      ...
      out.write("\twindow.location.assign(\"titleeditor/page1/page1.jsp\");\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function title2()\r\n");
      out.write("{\r\n");
      out.write("\talert(\"reached title2\");\r\n");
      out.write("\twindow.location.assign(\"titleeditor/page2/page2.jsp\");\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("                                                <h2 onClick=\"title2()\" style=\"color:");
      out.print( color1);
      out.write("\"> <font face=\"");
      out.print(font1);
      out.write("\"> ");
